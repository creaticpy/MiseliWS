# Generated by Django 4.0.3 on 2022-03-03 12:33
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ventas', '0010_pedidosmodel_realizado_por_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='PedidosRemisionesModel',
            fields=[
                ...
                ('pedido', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ventas.pedidosdetmodel')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='pedido',
            field=models.ManyToManyField(related_name='pedidos', through='ventas.PedidosRemisionesModel', to='ventas.pedidosdetmodel'),
        ),
        migrations.AddField(
            model_name='pedidosremisionesmodel',
            name='remision',
